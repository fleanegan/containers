...
TEST(reverseIterator, canDereferenceNormally) {
	...
	ft::reverse_iterator<ft::vector<simpleDummy>::iterator> revIt(vec.begin() + REVERSE_ITERATOR_OFFSET);
...
TEST(reverseIterator, advancingReverseIteratorMeansRetreating) {
	ft::vector<simpleDummy> vec = createTestDummyVector();
	ft::reverse_iterator<ft::vector<simpleDummy>::iterator> revIt(vec.begin() + REVERSE_ITERATOR_OFFSET + 1);
	ASSERT_EQ(2, **revIt);
...
TEST(reverseIterator, baseIteratorIsNotReverse) {
	ft::vector<simpleDummy> vec = createTestDummyVector();
	ft::reverse_iterator<ft::vector<simpleDummy>::iterator> revIt(vec.begin());
...
TEST(reverseIterator, accessingByIndexIsInversed){
	ft::vector<simpleDummy> vec = createTestDummyVector();
	ft::reverse_iterator<ft::vector<simpleDummy>::iterator> revIt(vec.rbegin());
...
TEST(reverseIterator, compareConstReverseIteratorAgainstNonConstReverseIterator) {
	ft::vector<simpleDummy> vec = createTestDummyVector();
	ft::reverse_iterator<ft::vector<simpleDummy>::iterator> revIt = vec.rbegin();
	ft::reverse_iterator<const ft::vector<simpleDummy>::iterator> constRevIt = vec.rbegin();
...
TEST(reverseIterator, distanceBetweenTwoReverseIteratorsIsNegative) {
	ft::vector<simpleDummy> vec = createTestDummyVector();
	ft::reverse_iterator<ft::vector<simpleDummy>::iterator> revIt(vec.begin());
	ft::reverse_iterator<ft::vector<simpleDummy>::iterator> revItEnd(vec.end());
...
TEST(reverseIterator, movingIteratorBackwards) {
	ft::vector<simpleDummy> vec = createTestDummyVector();
	ft::reverse_iterator<ft::vector<simpleDummy>::iterator> revIt(vec.begin() + 2);
